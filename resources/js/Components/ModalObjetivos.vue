    ...
    <q-dialog v-model="dialog" position="right" rounded>
        <q-carousel v-model="slide" vertical height="420px" transition-prev="slide-down" transition-next="slide-up"
            ...
            <q-carousel-slide :name="1">
                <div style="width: 300px;  max-width: 60vh; height: 100%;" classs="tw-flex tw-items-center">
                    
                    <div class="row  q-pb-none" style="height:100%">
                ...
                <div style="width: 300px;  max-width: 60vh; height:100%">
                    <div class="tw-flex  tw-items-center tw-h-full">
                        <div class="tw-flex tw-flex-col tw-text-center">
                            ...
                            <span>Todos temos objetivos. Coisas que queremos conquistar, a um curto ou a um longo prazo. Entretanto, para alcançar é preciso poupar. Use a opção "Cofre" para ler mais sobre. Para os Objetivos, nossa sugestão é a de destinar 20% dos ganhos mensais. Atualmente, você destinou <span class="tw-text-green-600">{{porcentagem(objetivo)}}</span> aos seus objetivos. Não se esqueça de poupar mensalmente😉. </span>
                        </div>
                    </div>
                </div>
            </q-carousel-slide>
