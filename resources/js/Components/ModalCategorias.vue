<template>
    <q-dialog v-model="dialog" position="right" rounded>
        <q-carousel v-model="slide" vertical height="460px" transition-prev="slide-down" transition-next="slide-up"
            ...
            <q-carousel-slide :name="1">
                <div style="width: 300px; max-width: 60vh; height:100%">
                    ...
                    <div class="tw-h-full">
                        <div v-if="temEntrada == false"
                            class="tw-text-center tw-mx-auto tw-h-full tw-flex tw-items-center tw-text-lg">
                            <div><img src="/images/custos1.png" class="tw-mx-auto tw-mb-2" />
                                <span class="tw-w-full">Parece que você ainda não tem entradas cadastradas no mês
                                    atual.🙁</span>
                            </div>
                        </div>
                        <div v-else>
                            ...
                            <div v-else class=" tw-mx-auto tw-text-center">
                                <span>Neste mês, o seu gasto com essa categoria é igual à média dos demais
                                    usuários.</span>
                            </div>
